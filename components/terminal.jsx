...
const InteractiveTerminal = ({ open, onClose, profile, lang }) => {
  ...
  const commands = {
    ...
    stack: () => [
      ...
      "data:      postgres · mongodb · redis · pglite (wasm)",
      "devops:    docker · nginx · github actions · railway · vps",
    ],
    cases: () => [
      "case_01  villa-jaconda   · booking + loyalty app (rn + express + postgres)",
      "case_02  avtotime        · social + market + exam prep, 4 codebases (react + expo + express + mongo)",
      "case_03  momentumx       · agency platform (next.js + three.js + asp.net core)",
      "case_04  aura-scanner    · document scanner, 83k lines (flutter + opencv + express)",
      "case_05  quant           · research system (ts + python + postgres)",
      "case_06  enard           · voice assistant, local llm (node + electron + expo) [private]",
      "",
