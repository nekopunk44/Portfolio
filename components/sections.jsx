...
/* ---------- Contact ---------- */
/* Mostly stroke-only line art, to match the site's 1px rules and wireframes.
   GitHub is the exception: the octocat is only itself as a solid mark, so it
   is filled and drawn a little smaller to even out the optical weight. */
const CHANNEL_ICONS = {
  telegram: { d: "M22 2 11 13M22 2l-7 20-4-9-9-4 20-7z" },
  whatsapp: { d: "M21 11.5a8.4 8.4 0 0 1-9 8.4 8.4 8.4 0 0 1-3.9-.9L3 21l2-5.1a8.4 8.4 0 0 1-.9-3.9 8.4 8.4 0 0 1 8.4-8.4h.5a8.4 8.4 0 0 1 8 8v.4z" },
  email: { d: "M2 6a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2z M22 7l-10 6.5L2 7" },
  github: {
    filled: true,
...
const ChannelIcon = ({ name }) => {
  ...
  return (
    <svg
      ...
      focusable="false"
    >
      {icon.d.split(" M").map((d, i) => <path key={i} d={i ? "M" + d : d} />)}
    </svg>
  );
};
